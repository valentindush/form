    ...
    <div class="container">
        ...
        <div class="users">
            ...
            <?php
                ...
                $getQuey = mysqli_query($connect, "SELECT * FROM mis_users WHERE (firstname LIKE '%$query%' OR lastname LIKE '%$query%' OR username LIKE '%$query%' OR email LIKE '%$query%'  OR  telephone LIKE '%$query%' OR  nationality LIKE '%$query%')");
                ...
                while($row = mysqli_fetch_assoc($getQuey)){
                    ...
                    <?php
                        ...
                        <div class="err">No users found matching </div>
        ...
        <div class="new">
            ...
            <a href="index.php"><i class="fa-solid fa-user-plus"></i> Back to home</a>
        </div>
        </div>
